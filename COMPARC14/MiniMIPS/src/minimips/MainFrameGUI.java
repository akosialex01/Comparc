...
public class MainFrameGUI extends javax.swing.JFrame 
{
 ...
 /////////////////////////////////Start of IF//////////////////////////////////
                if(PC < totLines)
                {
                    ...
                    {
                        if((cycles.get(CC-1).getEXMEM_OPCODE().matches("001000") || 
                            cycles.get(CC-1).getEXMEM_OPCODE().matches("110010")) && cycles.get(CC-1).getEXMEM_COND().matches("1"))
                        {
                            cycle.setIFInstNum(PC);
             ...
             if(stall == false && CC > 0)
             {
                ...
                if(!alex.matches("SD") && !rd.matches("R0")) //walang data hazard kapag SD
                {
             ...
             System.out.println("Counter: " + dCtr + " " + cycle.getdHazard());
