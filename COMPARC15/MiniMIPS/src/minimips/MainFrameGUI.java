...
public class MainFrameGUI extends javax.swing.JFrame 
{
 ...
 /////////////////////////////////Start of IF//////////////////////////////////
                if(PC < totLines)
                {
                    ...
                    else if (CC > 0 && cycles.get(CC-1).getdHazard() == false)
                    {
                        
                        if(cycles.get(CC-1).getcHazard() == true)
                        {
                            if(cycles.get(CC-1).getEXMEM_OPCODE().matches("001000") || cycles.get(CC-1).getEXMEM_OPCODE().matches("110010"))
                            {
                                
                                if(cycles.get(CC-1).getEXMEM_COND().matches("1"))
                                {
                                    cycle.setIFInstNum(PC);
                                    IFID_IR = instructions.get(PC).getOpcodeHex();
                                    cycle.setIFID_IR(IFID_IR);
                        ...
                        else    //if walang data hazard go lang
                        {
                            cycle.setIFInstNum(PC);
                            IFID_IR = instructions.get(PC).getOpcodeHex();
                            cycle.setIFID_IR(IFID_IR);
                    ...
                    else   //IF MAY DATAHAZARD
                    {
                        cycle.setIFInstNum(PC-1);
                        IFID_IR = instructions.get(PC-1).getOpcodeHex();
                        cycle.setIF_IR(IFID_IR);
                        IFID_NPC = this.PCtoHex(PC);
                        cycle.setIF_NPC(IFID_NPC);
                        cycle.setIF(true);
               ...
               else
               {
                   ...
                   //IF DATAHAZARD IS TRUE AND PC IS == TOTLINES
                   if(cycles.get(CC-1).getcHazard() == false)
                   {
                   cycle.setIFInstNum(PC-1);
                   IFID_IR = instructions.get(PC-1).getOpcodeHex();
                   cycle.setIF_IR(IFID_IR);
                   ...
                   if(cycles.get(CC-1).getcHazard() == true)
                   {
                        if(cycles.get(CC-1).getEXMEM_OPCODE().matches("001000") || cycles.get(CC-1).getEXMEM_OPCODE().matches("110010"))
                        {
                            ...
                            else if(cycles.get(CC-1).getEXMEM_COND().matches("0"))
                            {
                                cycle.setIFInstNum(PC);
                                IFID_IR = instructions.get(PC).getOpcodeHex();
                                cycle.setIFID_IR(IFID_IR);
                ...
                //END OF IF
             if(stall == false && CC > 0 && cycles.get(CC-1).getcHazard() == false)
             {
                String rd = "";
                String r1 = "";
                String r2 = "";
                ...
                {
                if(stall == false && insIndex + 1 < totLines)
                {
...
/////////////////////////////////Start of WB//////////////////////////////////                    
              ...
              for(int i = 0; i < cycles.size(); i++)
              {
                ...
                System.out.println("\nEXMEM_ALUOUTPUT:  " + cycles.get(i).getEXMEM_ALU());
                System.out.println("EXMEM_B:            " + cycles.get(i).getEXMEM_B());
                System.out.println("EXMEM_COND:         " + cycles.get(i).getEXMEM_COND());
                System.out.println("EXMEM_IR:           " + cycles.get(i).getEXMEM_IR());
                
                System.out.println("\nMEMWB_IR:         " + cycles.get(i).getMEMWB_IR());
                System.out.println("MEMWB_LMD:          " + cycles.get(i).getMEMWB_LMD());
                System.out.println("MEMWB_ALUOUTPUT:    " + cycles.get(i).getMEMWB_ALUOUTPUT());
                
                System.out.println("\nWB_RN:            " + cycles.get(i).getWB_RN());
              }
    ...
    private void fullBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fullBtnActionPerformed
        ...
        for(int a = 0 ; a < cycles.size(); a++)
        {
            ...
            cyclesTxtArea.setText(cyclesTxtArea.getText() + "\n"    +   "IF/ID.IR:"              + "\t\t"   + cycles.get(a).getIFID_IR());
            cyclesTxtArea.setText(cyclesTxtArea.getText() + "\n"    +   "IF/ID.NPC:"             + "\t\t"   + cycles.get(a).getIFID_NPC());
