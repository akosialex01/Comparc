...
public class MainFrameGUI extends javax.swing.JFrame 
{
    ...
    public MainFrameGUI()
    {
        ...
        opcodeTbl.getColumnModel().getColumn(0).setPreferredWidth(70);
        opcodeTbl.getColumnModel().getColumn(1).setPreferredWidth(125);
    ...
    private void runBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runBtnActionPerformed
            ...
            if(errorList.isEmpty())
            {
                ...
                for(int w = 0; w < 32; w++)
                {
                    ...
                    tempReg1 = registerTable.getValueAt(w, 0).toString(); /*Converts register (Object) to string*/
                    String str21[] = tempReg1.split("R"); /*Splits R and register number*/
                    
                    tempReg = str21[1];
                    regNumber = Integer.parseInt(tempReg); /*Converts string register number to int*/
