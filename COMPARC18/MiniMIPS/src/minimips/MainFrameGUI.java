...
public class MainFrameGUI extends javax.swing.JFrame 
{
    ...
    private String gotoHex = "";
    private int gotoDecimal;
    ...
    private void initComponents() {
        ...
        gotoTxtField = new javax.swing.JTextField();
        ...
        jLabel1.setText("Go to memory address: ");
        ...
        memoryPanelLayout.setVerticalGroup(
            ...
            .addGroup(memoryPanelLayout.createSequentialGroup()
                .addGroup(memoryPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(gotoTxtField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(gotoBtn))
 ...
 ///////////////////////////////////CYCLES////////////////////////////////////////////////////////////
  ...
  ////////////////////////////CHECK DATA HAZZARD ////////////////////////////////////
                if(CC > 0 && totLines >= 2 && stall == false)
                {
                    String rd = "";
                    String r1 = "";
                    String r2 = "";
                    ...
                    if(!alex.matches("SD") && !rd.matches("R0") && !alex.matches("BEQC")) //walang data hazard kapag SD
                    {
                        ...
                        if(randomBool == false && insIndex + 2 < totLines)
                        {
                            ...
                            if(rd.equals(r1) || rd.equals(r2))
                            {
                                ...
                                rd = instructions.get(insIndex + 1).getRD();
                                alex = instructions.get(insIndex + 1).getOpInst();
                                if(!alex.matches("SD") && !rd.matches("R0") && !alex.matches("BEQC"))
                                {
                                    if(rd.equals(r1) || rd.equals(r2))
                                    {
                                        dCtr = 3;
                        ...
                        if(randomBool == false && insIndex + 3 < totLines)
                        {
                            ...
                            if(rd.equals(r1) || rd.equals(r2))
                            {
                                ...
                                rd = instructions.get(insIndex + 2).getRD();
                                alex = instructions.get(insIndex + 2).getOpInst();
...
//////////////////////////////CHECK CONTROL HAZZARD//////////////////////////
               
                    if(stall == false && cHazard == false)
                    {
                        String control = "";
                        int instIndex = 0;
                        ...
                        if(instIndex >= 0 && instIndex < totLines)
                        {
                            control = instructions.get(instIndex).getOpInst();
                 ...
                 System.out.println("Cycle#" + CC + " PC: " + PC + " tempPC:" + tempPC + " cHazard: " + cHazard + " stall: " + stall);
                 
                 
 /////////////////////////////////Start of IF//////////////////////////////////
                if((PC < totLines && stall == false) || cHazard == true )
                {
                    if(cHazard == false && stall == false)
                    {
                    ...
                    else if(cHazard == true && stall == false && PC < totLines)
                    {
                        if(cycles.get(CC-1).getEXMEM_OPCODE().equals("001000") || cycles.get(CC-1).getEXMEM_OPCODE().equals("110010"))
                        {
                            if(cycles.get(CC-1).getEXMEM_COND().equals("1"))
                            {
                                controlBool = false;
                                cycle.setIFInstNum(PC);
                                cycle.setIFID_PC(Integer.toString(PC));
                                ...
                                IFID_IR = instructions.get(PC).getOpcodeHex();
                                IFID_NPC = cycles.get(CC-1).getEXMEM_ALU();


                                cycle.setIF_IR(IFID_IR);
                                cycle.setIF_NPC(IFID_NPC);
                                PC = this.HextoPC(IFID_NPC);


                            }

                            else if(cycles.get(CC-1).getEXMEM_COND().equals("0"))//PC gets tempPC
                            {   
                                controlBool = false;
                                cycle.setIFInstNum(PC);
                                cycle.setIFID_PC(Integer.toString(PC));
                ...
                if(cHazard == true && PC >= totLines) //DONT FETCH PERO CHECK YUNG EXMEMOPCODE
                {
                    if(cycles.get(CC-1).getEXMEM_OPCODE().equals("001000") || cycles.get(CC-1).getEXMEM_OPCODE().equals("110010") && cycles.get(CC-1).getcHazard() == true)
                    {
                        if(cycles.get(CC-1).getEXMEM_COND().equals("1"))
                        {
                            controlBool = false;
                        ...
                        else if(cycles.get(CC-1).getEXMEM_COND().equals("0"))
                        {   
                            controlBool = false;
                            PC = tempPC;
 ...
 /////////////////////////////////Start of ID//////////////////////////////////
                    ...
                    if(cycles.get(CC - 1).getIF() && cycles.get(CC-1).getdHazard() == false) // IF NAG FETCH NA
                    {
                        int currInst = 0;
...
/////////////////////////////////Start of MEM//////////////////////////////////
                    if(cycles.get(CC - 1).getEX())
                    {
                        ...
                        if(Str.matches("LD"))
                        {
                            ...
                            num1 = Long.parseUnsignedLong(temp,16);
...
/////////////////////////////////Start of WB//////////////////////////////////                    
                ...
                if(randomBool == true && randomCtr > 0) //randomCtr = waiting time bago mag stall
                {   
                    dHazard = false;
                    randomCtr--;
                }
                
                else if(randomBool== true && randomCtr == 0)
                   dHazard = true;
                
                if(stallCtr > 0 && dHazard == true)     //stallCtr = stall counter
                    stallCtr--;
                if(stallCtr == 0)
                    dHazard = false;
                if(dHazard == false && stall == true)   
                {
            ...
            for(int a = 0 ; a < cycles.size(); a++)
            {
                ...
                System.out.println("OPCODE:"                +"\t\t"    + cycles.get(a).getEXMEM_OPCODE());
    ...
    private void gotoBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gotoBtnActionPerformed
        ...
        gotoHex = gotoTxtField.getText();
        gotoHex = gotoHex.toUpperCase();
        if(gotoHex.matches("[0-9A-F]{4}"))
        {
            gotoDecimal = Integer.parseInt(gotoHex, 16);
            gotoDecimal = gotoDecimal - 8192;
        }
        
        if(gotoDecimal < 0 || gotoDecimal > 8192)
        {
        ...
        {
            memoryTable.scrollRectToVisible(memoryTable.getCellRect(gotoDecimal, 0, true));
        }
    ...
    private javax.swing.JTextField gotoTxtField;
